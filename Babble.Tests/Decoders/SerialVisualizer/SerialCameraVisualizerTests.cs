...
public class SerialCameraVisualizerTests : IDisposable
{
    private const string TEST_PORT = "COM5";
    private SerialCameraVisualizer _camera;

    public SerialCameraVisualizerTests()
    {
        _camera = new SerialCameraVisualizer(TEST_PORT);
    }
    ...
    {
        // Act
        var camera = new SerialCameraVisualizer(TEST_PORT);
    ...
    * And this function can't "stop" it in time to pass */
    ...
    {
        // Act
        Action act = () => new SerialCameraVisualizer(invalidPort);
